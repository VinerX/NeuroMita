...
LOCAL_VOICE_MODELS = [
    ...
    {"id": "edge_tts_rvc_onnx", "name": "Edge-TTS + RVC (ONNX)", "min_vram": 3, "rec_vram": 4, "gpu_vendor": ["AMD", "CPU"], "size_gb": 3},
    {"id": "silero_rvc_cuda", "name": "Silero + RVC (CUDA)", "min_vram": 3, "rec_vram": 4, "gpu_vendor": ["NVIDIA"], "size_gb": 3},
    {"id": "silero_rvc_onnx", "name": "Silero + RVC (ONNX)", "min_vram": 3, "rec_vram": 4, "gpu_vendor": ["AMD", "CPU"], "size_gb": 3},
