...
CATALOG_ENTRIES: tuple[InstallableCatalogEntry, ...] = (
    ...
    InstallableCatalogEntry(
        id='tts:omnivoice',
        loader='handlers.voice_models.omnivoice_model:OmniVoiceModel.create_installable_components',
        metadata_ru={'id': 'tts:omnivoice',
         'item_id': 'omnivoice',
         'category': 'tts',
         'title': 'OmniVoice',
         'description': 'Более доступная мультиязычная альтернатива Fish Speech: работает на тех же voice cuts, требует меньше места, но уступает Fish Speech по качеству и стабильности.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Клонирование голоса', 'Доступность'],
         'languages': ['Multilingual'],
         'size': '~3.3 GB',
         'compatibility': OMNIVOICE_CPU_FALLBACK_COMPATIBILITY},
        metadata_en={'id': 'tts:omnivoice',
         'item_id': 'omnivoice',
         'category': 'tts',
         'title': 'OmniVoice',
         'description': 'A more accessible multilingual alternative to Fish Speech: it uses the same voice cuts and needs less disk space, but trails Fish Speech in quality and stability.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Voice cloning', 'Accessibility'],
         'languages': ['Multilingual'],
         'size': '~3.3 GB',
         'compatibility': OMNIVOICE_CPU_FALLBACK_COMPATIBILITY},
    ),
    ...
    InstallableCatalogEntry(
        id='tts:high_clf5',
        loader='handlers.voice_models.f5_tts_model:F5TTSModel.create_installable_components',
        metadata_ru={'id': 'tts:high_clf5',
         'item_id': 'high_clf5',
         'category': 'tts',
         'title': 'Cross-Lingual F5-TTS (Английский и китайский)',
         'description': 'Кросс-языковая F5-TTS для клонирования голоса по русскому референсу и синтеза английской или китайской речи.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Кросс-языковое клонирование', 'Качество'],
         'languages': ['English', 'Chinese'],
         'size': '~4 GB',
         'compatibility': F5_CPU_FALLBACK_COMPATIBILITY},
        metadata_en={'id': 'tts:high_clf5',
         'item_id': 'high_clf5',
         'category': 'tts',
         'title': 'Cross-Lingual F5-TTS (English & Chinese)',
         'description': 'Cross-lingual F5-TTS that clones a Russian reference voice and synthesizes English or Chinese speech.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Cross-lingual cloning', 'Quality'],
         'languages': ['English', 'Chinese'],
         'size': '~4 GB',
         'compatibility': F5_CPU_FALLBACK_COMPATIBILITY},
    ),
    ...
    InstallableCatalogEntry(
        id='tts:high_clf5+low',
        loader='handlers.voice_models.f5_tts_model:F5TTSModel.create_installable_components',
        metadata_ru={'id': 'tts:high_clf5+low',
         'item_id': 'high_clf5+low',
         'category': 'tts',
         'title': 'Cross-Lingual F5-TTS + RVC (Английский и китайский)',
         'description': 'Cross-Lingual F5-TTS с последующей конверсией тембра через RVC.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Кросс-языковое клонирование', 'Конверсия голоса'],
         'languages': ['English', 'Chinese'],
         'size': '~7 GB',
         'compatibility': F5_RVC_FALLBACK_COMPATIBILITY},
        metadata_en={'id': 'tts:high_clf5+low',
         'item_id': 'high_clf5+low',
         'category': 'tts',
         'title': 'Cross-Lingual F5-TTS + RVC (English & Chinese)',
         'description': 'Cross-Lingual F5-TTS followed by timbre conversion through RVC.',
         'backend': 'cpu',
         'legacy_kind': 'voice',
         'tags': ['Cross-lingual cloning', 'Voice conversion'],
         'languages': ['English', 'Chinese'],
         'size': '~7 GB',
         'compatibility': F5_RVC_FALLBACK_COMPATIBILITY},
    ),
