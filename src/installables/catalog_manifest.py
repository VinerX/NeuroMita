...
CATALOG_ENTRIES: tuple[InstallableCatalogEntry, ...] = (
    ...
    InstallableCatalogEntry(
        ...
        metadata_ru={'id': 'backend:onnx',
         ...
         'category': 'backend',
         'title': 'ONNX Runtime',
         'description': 'CPU-режим на NVIDIA и DirectML на AMD/Intel. Устанавливается рядом с PyTorch и не удаляет его.',
         'backend': 'onnx',
         'legacy_kind': 'backend',
         'tags': ['system', 'onnx'],
         'languages': [],
        ...
        metadata_en={'id': 'backend:onnx',
         ...
         'category': 'backend',
         'title': 'ONNX Runtime',
         'description': 'Uses CPU on NVIDIA and DirectML on AMD/Intel. Installs alongside PyTorch without removing it.',
         'backend': 'onnx',
         'legacy_kind': 'backend',
         'tags': ['system', 'onnx'],
         'languages': [],
