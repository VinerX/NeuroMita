...
class ServerController:
    def __init__(self, game_link):
        ...
        self.settings_to_send = [
            'ACTION_MENU', 'MITAS_MENU', 'IGNORE_GAME_REQUESTS', 'GAME_BLOCK_LEVEL', 'MITA_DIALOGUE_AUTO', 'DIALOGUE_MAX_AUTO_TURNS', 'DIALOGUE_AUTO_TURN_COUNT_MODE', 'DIALOGUE_AUTO_TURNS_PER_PARTICIPANT', 'DIALOGUE_MAX_CONTINUES', 'GM_ON', 'GM_CHECK_INTERVAL', 'GM_REPEAT',
