...
class PromptController:
    ...
    def _on_build_prompt(self, event: Event) -> Dict[str, Any]:
        ...
        system_messages, dsl_system_infos = self._build_system_messages(character, event_type, separate_prompts, policy=policy)
    ...
    def _on_build_prompt(self, event: Event) -> Dict[str, Any]:
        ...
        system_messages, dsl_system_infos = self._build_system_messages(character, event_type, separate_prompts)
        messages.extend(system_messages)
